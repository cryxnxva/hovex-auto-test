...
class AppConfig:
    ...
    allowed_location_keywords: tuple[str, ...] = ("москва", "московская область", "подмосковье")
    """Названия города/региона, проходящих фильтр «Москва и Московская область».

    Сравнивается первый сегмент локации (до запятой) с префиксом «г. »,
    регистронезависимо. Точное вхождение не требуется по подстроке —
    поэтому «Московский проспект, Санкт-Петербург» не проходит, а
    «Москва» и «Московская область, г. Химки» — проходят."""
